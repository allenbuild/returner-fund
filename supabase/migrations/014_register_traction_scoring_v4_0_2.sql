-- Register date-invariant V4 scoring as a new immutable model version.
-- The 4.0.1 and 4.0.0 rows remain untouched as rollback targets.
...
declare
  ...
  v4_version constant text := '4.0.2';
  v4_config_hash constant text := 'b9c460c09b83902721cc6a456c50ddb1c9cffecc9e02d3cac3c504936f63e5a9';
