-- Register bounded primary-signal scoring as a new immutable model version.
...
declare
  ...
  v4_version constant text := '4.3.0';
  v4_config_hash constant text := '63dffd0fd55d7b4706a3e8d3e400d08cf7e962ec7ade9679fa8e9d8936afaa80';
