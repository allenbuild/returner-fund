...
- Historical production model used for this frozen experiment:
  ...
  production is `returner-traction@4.3.1`
  (`returner-traction-v4-bounded-primary-signal-calibrated`), which no longer
  uses the frozen experiment's recency component, bounds breadth influence,
  and applies the documented 95% level calibration.
