  ...
  it("returns the published score and ranked company/founder source links", async () => {
    ...
    expect(response).toMatchObject({
      ...
      returnerFund: {
        ...
        model: { id: "returner-traction", version: "4.2.0" },
      },
      postsReturned: 1,
...
function fixtureGraph(): GraphResponse {
  ...
  target.scoreBreakdown = {
    ...
    modelVersion: "4.2.0",
    modelName: "returner-traction-v4",
    totalScore: 70,
    absoluteScore: 37,
    ...
    platformScores: { x: 70 },
    weightedPlatforms: [],
    signalFamilyScores: { reach: 70, engagement: 60, developerAdoption: 0, launchAndCommunity: 0, momentum: 0 },
    confidence: {
      level: "high",
      value: 0.8,
      reasons: [],
    ...
    calibration: { method: "global_best_ratio", cohortSize: 3, percentile: null, inputScore: 37 },
    limitations: [],
